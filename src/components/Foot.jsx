export default function Footer() {
  ...
  return (
    <>
      <div className="border-t-2 pb-4 md:pb-0 border-t-fuchsia-900 w-full bg-fuchsia-900 text-[#fdfdfd] flex flex-col md:flex-row justify-center m-auto items-center align-middle lg:justify-evenly">
        <div className="h-48 w-full hidden md:block md:w-fit bg-fuchsia-50">
          <img src="/logo_clean.png" alt="logo" className="h-48 m-auto" />
        </div>
        <div className="mx-auto flex flex-row items-center justify-between mx-auto w-full md:w-fit">
        <img src="/logo_clean.png" alt="logo" className="h-36 md:hidden  bg-fuchsia-50 rounded-full p-3 m-3" />
